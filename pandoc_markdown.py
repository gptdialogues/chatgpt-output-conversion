...
def main():
    ...
    parser.add_argument('-v', '--verbose', action='store_true', help='Verbose mode. Print out intermediate processes.')
    ...
    if args.verbose:
        print("Data loading completed. Proceeding with output...")
    ...
    if args.verbose:
        print("Process completed. Check your output.")
